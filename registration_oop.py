...
class AccountManager:
    ...
    def log_pass_input(self) -> tuple[str, str]:
        """
...
def commands(self):
    ...
    1. Регистрация: Выбор этой опции позволяет вам зарегистрировать новую
       учетную запись пользователя, указав имя пользователя и пароль.
    2. Авторизация: При выборе этой опции вам будет предложено ввести свое
       имя пользователя и пароль для входа в существующую учетную запись.
